...
do
    ...
    python -u -m TSX.main --data simulation_spike --model risk_predictor --predictor RNN --train --cv $cv
    python -u -m TSX.main --data simulation_spike --model risk_predictor --predictor attention --train --cv $cv
    python -u -m TSX.main --data simulation_spike --model feature_generator_explainer --generator joint_RNN_generator --predictor attention --cv $cv --all_samples
    python -u -m TSX.main --data simulation_spike --model feature_generator_explainer --generator joint_RNN_generator --predictor RNN --cv $cv --all_samples
done

...
def load_data(batch_size, path='./data/', **kwargs):
    ...
    p_data = PatientData(path, task = task,shuffle=False)
    ...
    train_loader_gen = DataLoader(train_dataset, batch_size=batch_size,
        sampler=utils.SubsetRandomSampler(range(int(train_pc*len(train_idx)))))
